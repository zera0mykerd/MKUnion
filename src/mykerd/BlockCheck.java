...
public class BlockCheck {
  ...
  public double adjustY = 0.0D;
  
  public BlockCheck(Block block) {
    Block above = block.getLocation().clone().add(0.0D, 1.0D, 0.0D).getBlock(), below = block.getLocation().clone().add(0.0D, -1.0D, 0.0D).getBlock(), upTwo = block.getLocation().clone().add(0.0D, 2.0D, 0.0D).getBlock(), downTwo = block.getLocation().clone().add(0.0D, -2.0D, 0.0D).getBlock();
...
private boolean isTopDoor(Block block) {
    return !isTrapDoor(block) ? false : (!(block.getData() != 8 && block.getData() != 9 && block.getData() != 10 && block.getData() != 11));
  }
  
  @SuppressWarnings("deprecation")
private boolean isTopSlab(Block block) {
    return !isSlab(block) ? false : (!(block.getData() != 8 && block.getData() != 9 && block.getData() != 10 && block.getData() != 11 && block.getData() != 12 && block.getData() != 13 && block.getData() != 14 && block.getData() != 15));
  }
